      ...
      <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div className="mx-auto max-w-sm lg:max-w-none">
            ...
            Unlock the power of words with the help of Artificial Intelligence. Whether you're a beginner or looking to sharpen your skills, today's the perfect day to start your content writing journey. From blog posts to website copy, product descriptions to social media captions—AI can assist, inspire, and elevate your writing like never before. Let’s turn ideas into impactful stories—faster, smarter, and more creatively.
            </p>
            ...
            <div className="mt-6 flex justify-center gap-4 lg:justify-start">
              ...
              <Link
                className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
                href="https://github.com/ItsabhijeetWadichar12/ai-content-generator"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <div className="mt-16 border-t border-gray-100 pt-8 dark:border-gray-800">
          <p className="text-center text-xs/relaxed text-gray-500 dark:text-gray-400">
            © AI-CG 2025. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
